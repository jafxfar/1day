  ...
  return (
    <Layout hideNav={true}>
      <div className="flex flex-col justify-center min-h-[80vh] px-4 py-6 space-y-6">
        {/* Card wrapper */}
        <div className="bg-card border border-border rounded-2xl p-6 shadow-retool-md space-y-6">
          {/* Header */}
          <div className="flex flex-col items-center text-center gap-2">
            <div className="w-10 h-10 rounded-3xl bg-primary flex items-center justify-center shadow-retool-sm">
